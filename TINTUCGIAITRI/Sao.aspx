<%@ Page Title="Sao" Language="C#" MasterPageFile="~/TrangChu.Master" AutoEventWireup="true" CodeBehind="Sao.aspx.cs" Inherits="TINTUCGIAITRI.Sao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h2><b style="font-weight:bold;font-size:30px;text-shadow: 5px 4px 6px silver;color:#9918f2;margin-left:-730px;">Tin Tức Sao </b>   </h2>
    <div style="margin-left:850px">
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" OnSelectedIndexChanged="hihi">
            <asp:ListItem Value="1">Sao</asp:ListItem>
    ...
    <div class="thongtin">
     ...
     <HeaderStyle BackColor="Green" Font-Bold="True" Font-Italic="False" Font-Names=".Vn3DH" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" ForeColor="Fuchsia" HorizontalAlign="Left" VerticalAlign="Middle" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TTTN_TINTUCGIAITRIConnectionString %>" SelectCommand="Select IDBangTin,TieuDe,Anh,NgayDang,TheLoai.IDTheLoai from ChiTiet inner join TheLoai on ChiTiet.IDTheLoai=TheLoai.IDTheLoai where ChiTiet.IDTheLoai=1 AND (ChiTiet.TrangThai is not null) order by ngaydang desc"></asp:SqlDataSource>
     ...
     <HeaderStyle BackColor="Green" Font-Bold="True" Font-Italic="False" Font-Names=".Vn3DH" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" ForeColor="Fuchsia" HorizontalAlign="Left" VerticalAlign="Middle" />
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:TTTN_TINTUCGIAITRIConnectionString %>" SelectCommand="Select  top 3 IDBangTin,TieuDe,Anh,NgayDang,TheLoai.IDTheLoai,lanxem from ChiTiet inner join TheLoai on ChiTiet.IDTheLoai=TheLoai.IDTheLoai where ChiTiet.IDTheLoai=1 AND (ChiTiet.TrangThai is not null) order by lanxem desc "></asp:SqlDataSource>
     ...
     <HeaderStyle BackColor="Green" Font-Bold="True" Font-Italic="False" Font-Names=".Vn3DH" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" ForeColor="Fuchsia" HorizontalAlign="Left" VerticalAlign="Middle" />
                ...
                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:TTTN_TINTUCGIAITRIConnectionString %>" SelectCommand="Select  top 3 IDBangTin,TieuDe,Anh,NgayDang,TheLoai.IDTheLoai,lanxem from ChiTiet inner join TheLoai on ChiTiet.IDTheLoai=TheLoai.IDTheLoai where ChiTiet.IDTheLoai=1 AND (ChiTiet.TrangThai is not null) order by ngaydang desc "></asp:SqlDataSource>
